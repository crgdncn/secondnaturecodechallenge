                <div class="card-body">
                    <form method="POST" action="{{ $form_route }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') ?? $first_name ?? '' }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ Request::segment(1) == 'register' ? 'Register' : 'Save' }}
                                </button>
                                @if ( Request::segment(1) != 'register')
                                <a href="{{ route('customer.show', [$id ?? ''], false) }}" class="btn btn-primary">
                                    Cancel
                                </a>
                                @endif
                            </div>
